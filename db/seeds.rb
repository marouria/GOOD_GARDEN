...
Material.create!(name: "Terreau 50L", description: "Rempotez comme jamais avec ce sac de 5kg de terreau fraîchement déporté des flandres intérieures.", price: 15, image_url: 'soil.jpg')
